...
public class UploadFilesPageUI {
    ...
    public static final String DYNAMIC_ADDED_FILE_ACTION_BUTTON = "xpath=//p[text()='%s']/parent::td/parent::tr//button[contains(@class,'%s')]";
    ...
    public static final String DYNAMIC_UPLOADED_FILE_DELETE_BUTTON = "xpath=//a[text()='%s']/parent::p/parent::td/parent::tr//button[@class='btn btn-danger delete']";

    public static final String DYNAMIC_ALL_FILES_ACTION_BUTTON = "xpath=//div[@class='row fileupload-buttonbar']//button[contains(@class,'%s')]";
